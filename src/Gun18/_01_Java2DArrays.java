...
public class _01_Java2DArrays {
    public static void main(String[] args) {
         ...
         int[][] tablo1={               //int sayi=5;   int[] dizi={34,5,6,77,88};
                 {34,55,6},
                 {32,77,89}
         };  // ilk değerlerini ataryarak boyutlarını da belirlemiş olursun
         ...
         dizi=new int[7];  // içind edeğer var ise gider, son hali geçerli


         //2 boyutlu dizilerde
         tablo=new int[3][4];  // 2DArray i tümünü yeniden oluşturdun

         tablo[0]=new int[10];  // herhangi bir satırı yeniden boyutlandırabiliriz
                                // tüm satırlar aynı uzunlukta olmak zorunda değil.

        int[][] tablo3={  // atadığımız değerlerin miktarı boyutları belirler
                {23,44},
                {34,56,56,76,8,89,9},
                {5}
        };
