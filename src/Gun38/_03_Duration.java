...
public class _03_Duration {
    public static void main(String[] args) {
        ...
        long startTime= System.currentTimeMillis(); // şu andaki milisaniye cinsinden zamanı aldın
        ...
        System.out.println("toMinutes() = " + gunlukDersSuresi.toMinutes()); //toplam dak hali
        System.out.println("toSeconds() = " + gunlukDersSuresi.getSeconds()); // toplam sn hali
