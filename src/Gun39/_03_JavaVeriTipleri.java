...
public class _03_JavaVeriTipleri {
    public static void main(String[] args) {
        ...
        // İlekl tipler, içinde sadece bir değer tutan basit tipler,double,boolean,int
        int sayi1=5;
        int sayi2=8;
        ...
        // Acab dizi1 değiştirsem dizi 2 etkilenir mi
        ...
        // Nesne Tipler Double,Float,Integer,Bollean,String
        // NULL alabilen veya değer ataması yapılmayabilen İLKEL tiplerdir.
        // Hazıfa yerleşimi Referans Tip gibi, ama davranışı İLKEL gibi.
        ...
        String s4="ismet"; // değer atandı değer kutucuğu var
        ...
        System.out.println("s2 = " + s2); // null değerini stringe cast yapar
