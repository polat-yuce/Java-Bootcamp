...
public class _02_Soru_2 {
    public static void main(String[] args) {
        ...
        // var ise yerini/yerlerini (satir,sütun) yazdırınız.Bulamazsa
        // Bulamadınız yazdırınız
        ...
        System.out.print("Sayı giriniz=");int aranacakSayi=oku.nextInt();
        ...
        for (int i = 0; i < tablo.length; i++) {
            for (int j = 0; j < tablo[i].length; j++) {
                if (tablo[i][j]==aranacakSayi) {
                    ...
                    bulundu=true;
                    // break; ilk buludğunda çık, yani bir kez yaz
                }
            }
        }
