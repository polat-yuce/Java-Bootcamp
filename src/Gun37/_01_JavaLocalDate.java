...
public class _01_JavaLocalDate {
    public static void main(String[] args) {
        ...
        System.out.println("tarih.getDayOfWeek().getValue() = " + tarih.getDayOfWeek().getValue()); // haftanın günü sayı
        System.out.println("tarih.getDayOfYear() = " + tarih.getDayOfYear()); // yılın günü

        // Formatlı Gösterimler
        // a) sistem hazır olan formatlarla gösterim
        ...
        // b) Kendi hazırladığımız şablonalar gösterim
        ...
        System.out.println("tarih EEEE dd.MM.YYYY = " + tarih.format(ozf3));  // Thursday 08.08.2024

        DateTimeFormatter ozf4= DateTimeFormatter.ofPattern("EE dd.MM.YYYY");
        System.out.println("tarih EE dd.MM.YYYY = " + tarih.format(ozf4));  // Thu 08.08.2024

        DateTimeFormatter ozf5= DateTimeFormatter.ofPattern("MMMM EEEE dd.MM.YYYY");
        System.out.println("tarih MMMM EEEE dd.MM.YYYY = " + tarih.format(ozf5));  // August Thursday 08.08.2024
    }
}
