...
public class _07_JavaMath {
    public static void main(String[] args) {
        ...
        System.out.println("ceil 3.5 ="+ Math.ceil(3.5)); // 4 , bu rakamdan büyük en yakın tam sayı

        System.out.println("floor 3.1 ="+ Math.floor(3.1)); // 3 , bu rakamdan küçük en yakın tam sayı
        System.out.println("floor 3.5 ="+ Math.floor(3.5)); // 3 , bu rakamdan küçük en yakın tam sayı
    }
}
