...
public class _01_ArrayDizi {
    public static void main(String[] args) {
        int sayi;   // 1 tane sayi saklayacak hafıza bölgesi, adı da sayi
        float oran; // 1 tane kesirli bölümü olabilen hazfıza bölgesi, adı da oran

        sayi=5; // sayi isimli hafıza kutusunnun içide 5 değeri var
        ...
        System.out.println("notlar[49] yani sonuncu yani 50.öğrencinin notu = " + notlar[49]); // 45
